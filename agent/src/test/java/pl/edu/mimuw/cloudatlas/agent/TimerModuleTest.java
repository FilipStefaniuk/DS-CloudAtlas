...
//import pl.edu.mimuw.cloudatlas.agent.timer.TimerMessage;
//import pl.edu.mimuw.cloudatlas.agent.modules.TimerModule;
//
...
//        TimerMessage msg = new TimerMessage(SENDER_ID, SENDER_HANDLE, REQUEST_ID, DELAY, START_TIMER);
